# Integration Tests for helmupdater

This directory contains end-to-end integration tests for helmupdater with local Helm registries (HTTP and OCI).
...
helm show chart localhost:45020/charts/nginx
